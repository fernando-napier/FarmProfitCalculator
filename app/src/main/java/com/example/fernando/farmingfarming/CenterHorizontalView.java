...
public class CenterHorizontalView extends HorizontalScrollView implements View.OnTouchListener {
    ...
    public CenterHorizontalView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void scrollToActiveItem() {
        ...
        int height=400;//set size of centered image
    ...
    //TODO: create a method that takes the current centered item, and is listened for
    //TODO: by the original class
